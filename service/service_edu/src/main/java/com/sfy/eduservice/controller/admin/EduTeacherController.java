...
import com.sfy.eduservice.entity.dto.admin.TeacherQuery;
...
public class EduTeacherController {
    ...
    @DeleteMapping("deleteById/{id}") //id值需要通过路径进行传递
    ...
    public R pageTeacherCondition(@PathVariable long current,
        ...
        if(!StringUtils.isEmpty(begin)) {
            wrapper.ge("gmt_create", begin); //均为表中字段名称
        }
