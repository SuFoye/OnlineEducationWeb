...
import com.sfy.aclservice.entity.Role;
import com.sfy.aclservice.service.IndexService;
import com.sfy.aclservice.service.PermissionService;
import com.sfy.aclservice.service.RoleService;
...
public class IndexServiceImpl implements IndexService {
    ...
    public Map<String, Object> getUserInfo(String username) {
        ...
        if (null == user) {
            //throw new HuitongException(ResultCodeEnum.FETCH_USERINFO_ERROR);
        }
